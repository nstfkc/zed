...
fn main() {
    ...
    app.run(move |cx| {
        ...
        // Force these single-`init()` crates' objects to stay linked. lld's
        ...
        std::hint::black_box(exec_command::init as fn(&mut gpui::App));
        std::hint::black_box(minibuffer::init as fn(&mut gpui::App));
