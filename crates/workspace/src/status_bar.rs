...
impl StatusBar {
    ...
    /// The centered item group, laid out in the middle of the status bar (it
    /// grows to fill the space between the left and right groups and centers its
    /// contents).
...
impl StatusBar {
    ...
    /// Adds an item to the centered group in the middle of the status bar.
